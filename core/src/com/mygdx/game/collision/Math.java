...
public class Math {
  ...
  public static CollisionPointPair getCollisionPointsBetweenLineAndEllipse(
    ...
    double D1 = java.lang.Math.sqrt(
        -a * b * k22 * y02 + (2 * a * b * k2 * k3 - 2 * a * b * k1 * k2 * x0) * y0
            - a * b * k12 * x02 + 2 * a * b * k1 * k3 * x0 - a * b * k32 + a * b2 * k22
            + a2 * b * k12);
    double xr = a * k1 * k2 * y0 - b * k22 * x0 - a * k1 * k3;

    double D2 = java.lang.Math.sqrt(a * b) * k1 * java.lang.Math.sqrt(
        -k22 * y02 - 2 * k1 * k2 * x0 * y0 + 2 * k2 * k3 * y0 - k12 * x02 + 2 * k1 * k3 * x0 - k32
            + b * k22 + a * k12);
